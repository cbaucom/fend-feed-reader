...
$(function() {
    ...
    */
    ...
    describe('The menu', function() {
         ...
         * visibility when the menu icon is clicked. It has two expectations: does the menu display when
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                // grab and save the old title
                oldContent = $('.feed').find('h2').text();
                done();
            });
        });

        it ('content changes based on feed selection', function(done) {
            loadFeed(1, function() {
                // grab new feed and save the new title
                newContent = $('.feed').find('h2').text();

                // compare old to new. they should not match
